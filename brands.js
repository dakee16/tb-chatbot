...
// request, and the backend uses it to pick the right accent color, product
// feed, contact info, and Zammad chat.
//
// To add or change a brand: edit this file, git push, git pull on the VPS,
// pm2 restart. Nothing else needs to change.
//
// NOTE ON FEED URLs: tilesbay's real feed is confirmed. The other eight follow
// the same pattern once the owner generates them from the same template. Update
// each `feedUrl` below with the real per-site feed path (the number after
// "chatbot" is that site's feed-profile id and will differ per store).
...
const DEFAULT = {
  ...
  export const BRANDS = {
    tilesbay: {
      ...
      feedUrl: 'https://www.tilesbay.com/media/feed/chatbot1601.xml', // CONFIRMED
      apiKeyEnv: 'TILESBAY_API_KEY',          // chatbot-api.php fallback key
      contact: { email: 'csr@tilesbay.com', phone: '(855) 740-5157' },
      zammadChatId: 1,
    ...
    findstone: {
      ...
      feedUrl: 'https://www.findstone.us/media/feed/chatbot.xml', // TODO: real feed url
      apiKeyEnv: 'FINDSTONE_API_KEY',
    ...
    flooringntile: {
      ...
      feedUrl: 'https://www.flooringntile.com/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'FLOORINGNTILE_API_KEY',
    ...
    backsplash: {
      ...
      feedUrl: 'https://www.backsplash-tile.us/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'BACKSPLASH_API_KEY',
    ...
    floortiles: {
      ...
      feedUrl: 'https://www.floor-tiles.us/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'FLOORTILES_API_KEY',
    ...
    patiopavers: {
      ...
      feedUrl: 'https://www.patio-pavers.us/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'PATIOPAVERS_API_KEY',
    ...
    porcelaintile: {
      ...
      feedUrl: 'https://www.porcelain-tile.us/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'PORCELAINTILE_API_KEY',
    ...
    stackedstone: {
      ...
      feedUrl: 'https://www.stacked-stone.us/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'STACKEDSTONE_API_KEY',
    ...
    lvp: {
      ...
      feedUrl: 'https://www.luxury-vinyl-plank-flooring.com/media/feed/chatbot.xml', // TODO
      apiKeyEnv: 'LVP_API_KEY',
